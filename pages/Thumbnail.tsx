  ...
  return (
    <div className="min-h-screen grid place-items-center p-4 bg-gray-900">
      <div className="w-[640px] h-[360px] bg-white relative overflow-hidden">
        <div
          aria-hidden="true"
          className="w-[512px] h-[512px] bg-purple-200 absolute rounded-full -top-20 -right-56 "
        ></div>
        ...
        <div className="absolute top-44 right-8">
          <img
            ...
            alt="screenshot of tailwind code"
            className="w-64 h-36 object-cover rounded-2xl shadow-2xl -rotate-3 translate-x-8"
          />
        </div>
        <div className="absolute right-12 inset-y-0 grid items-center">
          <a
            href="#"
            className="w-12 h-12 bg-purple-800 rounded-full ring-4 ring-white hover:bg-purple-400 transition"
          >
            <span className="sr-only">Watch the video</span>
            <svg
              className="ml-4 mt-2 w-6"
              viewBox="0 0 16 18"
              fill="none"
        ...
        <div
          aria-hidden="true"
          className=" w-[200px] h-[200px] bg-purple-200 rounded-full absolute -top-16 -left-12 grid place-items-center "
        >
          <svg
        ...
        <div className=" relative p-8 flex flex-col justify-end h-full space-y-4 ">
          <p className="uppercase font-semibold text-xs text-purple-600 tracking-wider">
            How we'd build it
          </p>
          <h1 className="text-4xl font-extrabold text-gray-900 w-2/3">
